                ...
                <div class="col-lg-6 m-auto">
                    <div class="card">
                        <div class="card-header">
                            <RouterLink :to="{ name: 'List' }" type="button" class="btn btn-danger btn-sm add"
                                style="float: right;">List Customer </RouterLink>
                            ...
                            <form @submit.prevent="UpdateData">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <span v-if="errors.full_name" class="text-danger">{{ errors.full_name[0]
                                            }}</span>
                                    </div>
...
export default {
    ...
    methods: {
        ...
        UpdateData() {
            axios.post('/api/customer/update/' + this.$route.params.id, this.formData)
                .then(response => {
                    this.errors = {};
